...
const CONFIG = {
  ...
  DASHBOARD_BY_ROLE: {
    ...
    admin:        "../Commisie/stage-beoordeling/commissie.aanvraag-beoordeling.html?id=4",
    mentor:       "../Student/empty-stage/empty-stage.html",
    commissielid: "../Commisie/stage-beoordeling/commissie.aanvraag-beoordeling.html?id=4",
  },
